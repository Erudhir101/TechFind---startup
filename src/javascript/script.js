...
$('#senha-pf').on('input', function () {
    let senha = $(this).val();
    verificarForcaSenha(senha, $('#senha-strength-bar-pf'), $('#senha-strength-label'));
  });

  $('#senha-pj').on('input', function () {
    let senha = $(this).val();
    verificarForcaSenha(senha, $('#senha-strength-bar-pj'), $('#senha-strength-label-pj'));
  });
  ...
  $('form').on('submit', function (e) {
    ...
    if ((strengthPf < 66 && $('#senha-pf').is(':visible')) || (strengthPj < 66 && $('#senha-pj').is(':visible'))) {
